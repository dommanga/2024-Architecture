...
void Vvending_machine___024root__trace_chg_0_sub_0(Vvending_machine___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelf->__Vm_traceActivity[1U] 
        ...
        bufp->chgIData(oldp+8,(vlSelf->vending_machine__DOT__relative_money),32);
        bufp->chgIData(oldp+9,(vlSelf->vending_machine__DOT__calculate_current_state_module__DOT__i),32);
        bufp->chgIData(oldp+10,(vlSelf->vending_machine__DOT__calculate_current_state_module__DOT__input_total),32);
        bufp->chgIData(oldp+11,(vlSelf->vending_machine__DOT__calculate_current_state_module__DOT__output_total),32);
        bufp->chgBit(oldp+12,(vlSelf->vending_machine__DOT__calculate_current_state_module__DOT__turn));
    }
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
        bufp->chgIData(oldp+13,(vlSelf->vending_machine__DOT__current_total),32);
