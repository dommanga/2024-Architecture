...
void Vvending_machine___024root__trace_chg_0_sub_0(Vvending_machine___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        bufp->chgIData(oldp+8,(vlSelf->vending_machine__DOT__return_total),32);
        bufp->chgIData(oldp+9,(vlSelf->vending_machine__DOT__wait_time),32);
        bufp->chgIData(oldp+10,(vlSelf->vending_machine__DOT__calculate_current_state_module__DOT__i),32);
        bufp->chgIData(oldp+11,(vlSelf->vending_machine__DOT__check_time_and_coin_module__DOT__relative_money),32);
        bufp->chgIData(oldp+12,(vlSelf->vending_machine__DOT__check_time_and_coin_module__DOT__temp),32);
        bufp->chgIData(oldp+13,(vlSelf->vending_machine__DOT__check_time_and_coin_module__DOT__i),32);
    }
    bufp->chgBit(oldp+14,(vlSelf->clk));
    bufp->chgBit(oldp+15,(vlSelf->reset_n));
    bufp->chgCData(oldp+16,(vlSelf->i_input_coin),3);
    bufp->chgCData(oldp+17,(vlSelf->i_select_item),4);
    bufp->chgBit(oldp+18,(vlSelf->i_trigger_return));
    bufp->chgCData(oldp+19,(vlSelf->o_available_item),4);
    bufp->chgCData(oldp+20,(vlSelf->o_output_item),4);
    bufp->chgCData(oldp+21,(vlSelf->o_return_coin),3);
    bufp->chgIData(oldp+22,((((0U == vlSelf->vending_machine__DOT__wait_time) 
                              ...
                              ? 4U : ((0U < (IData)(vlSelf->i_input_coin))
                                       ? 2U : ((0U 
                                                ...
                                                ? 3U
                                                : 1U)))),32);
    bufp->chgIData(oldp+23,(vlSelf->vending_machine__DOT__input_total),32);
    bufp->chgIData(oldp+24,(vlSelf->vending_machine__DOT__output_total),32);
}
