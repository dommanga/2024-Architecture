...
void Vvending_machine___024root__trace_chg_0_sub_0(Vvending_machine___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        bufp->chgBit(oldp+11,(vlSelf->vending_machine__DOT__check_time_and_coin_module__DOT__flag));
    }
    ...
    bufp->chgIData(oldp+20,((((4U == vlSelf->vending_machine__DOT__current_total) 
                                       ...
                                       ? 4U : ((0U 
                                                ...
                                                : (
                                                   (0U 
                                                    ...
                                                    ? 3U
                                                    : 1U))))),32);
    bufp->chgIData(oldp+21,(vlSelf->vending_machine__DOT__relative_money),32);
    bufp->chgIData(oldp+22,(vlSelf->vending_machine__DOT__calculate_current_state_module__DOT__input_total),32);
    bufp->chgIData(oldp+23,(vlSelf->vending_machine__DOT__calculate_current_state_module__DOT__output_total),32);
}
